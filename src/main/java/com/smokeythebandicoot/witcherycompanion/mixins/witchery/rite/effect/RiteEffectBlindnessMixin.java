...
@Mixin(RiteEffectBlindness.class)
public class RiteEffectBlindnessMixin {
    ...
    public boolean strengthTweak(EntityPlayer allowLightning, ItemStack i, EntityLivingBase attackingEntity, int strength, Operation<Boolean> original) {
        return original.call(allowLightning, i, attackingEntity, ModConfig.PatchesConfiguration.RitesTweaks.blindness_tweakStrength);
    }
