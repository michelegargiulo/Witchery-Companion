...
public class BrazierApi {
    ...
    public static void registerSummoningRecipe(ResourceLocation id, Ingredient input1, Ingredient input2, Ingredient input3, int burnTime, boolean needsPower, EntityType<EntityCreature> summon, EntityType<EntityCreature> extra) {
    ...
    public static void registerEffectRecipe(ResourceLocation id, Ingredient input1, Ingredient input2, Ingredient input3, int burnTime, boolean needsPower, Potion potion, int radius) {
        // Generate random id if one is not provided
