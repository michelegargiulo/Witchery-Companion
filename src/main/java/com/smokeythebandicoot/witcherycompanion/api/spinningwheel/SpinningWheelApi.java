...
public class SpinningWheelApi {
    ...
    public static void registerRecipe(@Nullable ResourceLocation id, ItemStack result, Ingredient fibre, int fibreCount, Ingredient modifier1, Ingredient modifier2, Ingredient modifier3) {
