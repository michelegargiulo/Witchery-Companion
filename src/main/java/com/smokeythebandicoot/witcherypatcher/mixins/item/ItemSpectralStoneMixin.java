 ...
 */
@Mixin(value = ItemSpectralStone.class, remap = false)
public class ItemSpectralStoneMixin {

    @WrapOperation(method = "onPlayerStoppedUsing", remap = false,
    at = @At(value = "INVOKE", target = "Lnet/minecraft/item/ItemStack;splitStack(I)Lnet/minecraft/item/ItemStack;"))
